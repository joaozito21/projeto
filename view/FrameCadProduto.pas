...
type
  ...
  public
    { Public declarations }
      ...
      modi : boolean;
      pro_id:integer;
      list:tobjectlist<tcategoriaPro>;
...
var
  lista:TObjectList<tcategoriaPro>;
  I:integer;
begin
  ...
  begin
    for I := 0 to list.Count -1  do
     cmbCat.Items.Add(list.Items[I].descricao);
      ...
      begin
        if modi then
            alterar_produto(EdtNome.Text,EdtValor.Text,
                      EdtVal.Text,Edtesto.Text,pro_id,id)
        else
          inserir_produto(EdtNome.Text,EdtValor.Text,
                      EdtVal.Text,Edtesto.Text,id);
      end;
    end;
